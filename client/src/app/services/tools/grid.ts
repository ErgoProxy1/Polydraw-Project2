...
import { DEFAULT_GRID_ALPHA, MAX_ALPHA, MAX_GRID_SIZE, MIN_GRID_ALPHA, MIN_GRID_SIZE, ToolType } from '../utils/constantsAndEnums';
...
export class Grid extends Tool {
  ...
  constructor() {
    super();
    this.sizeOfSquareGrid = MIN_GRID_SIZE;
