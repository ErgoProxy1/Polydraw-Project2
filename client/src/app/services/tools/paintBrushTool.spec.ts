...
import { KeyboardEventType, MouseEventType, Texture } from '../utils/constantsAndEnums';
...
describe('PaintBrushTool', () => {
    ...
    it('Path properly finishes', () => {
        const expected: PaintBrushCommand = new PaintBrushCommand(new Color(128, 64, 32, 0.5), 5, Texture.Basic);
