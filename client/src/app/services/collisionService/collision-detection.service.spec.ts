...
describe('CollisionDetectionService', () => {
  ...
  // Collision rectangle with Stamp
    ...
    rectangle.setNewDimension(2, 2);
    rectangle.setCenter(new Point(2, 2));
    expect(service['checkCollisionWithStamp'](rectangle, dummyStamp)).toBe(false);
  ...
  // Collision rectangle with Stamp
    ...
    rectangle.setNewDimension(2, 2);
    rectangle.setCenter(new Point(5, 5));
    expect(service['checkCollisionWithStamp'](rectangle, dummyStamp)).toBe(true);
  ...
  // test de testCollision entre un rectangle et une primitive
    ...
    dummyStamp['bottomRightCorner'] = new Point(25, 15);
    eraser.setCenter(new Point(8, 8));
    expect(service['checkCollision'](eraser, dummyStamp)).toBe(true);
