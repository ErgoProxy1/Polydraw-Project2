...
export class CollisionDetectionService {
  ...
  checkCollision(eraser: Rectangle, shape: SVGPrimitive): boolean {
    ...
    switch (shape.type) {
      ...
      case PrimitiveType.Stamp:
        collisionDetected = this.checkCollisionWithStamp(eraserCopy, (shape as Stamp));
        break;
  ...
  private checkCollisionWithStamp(eraser: Rectangle, stamp: Stamp): boolean {
    return this.checkCollisionBetweenRectangles(eraser.getTopLeftCorner(),
      eraser.getBottomRightCorner(), stamp.getTopLeftCorner(), stamp.getBottomRightCorner());
  }
