...
describe('GridPropertiesComponent', () => {
  ...
  it('the size of square should be set to the default value of the grid', async(() => {
  ...
  it('the alpha of grid should be set to the default value of the grid', async(() => {
    fixture.whenStable().then(() => {
  ...
  it('the toShow switch should be set to the default value of the grid', async(() => {
    fixture.whenStable().then(() => {
